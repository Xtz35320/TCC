...
function preencherFormulario() {
  ...
  <div class="form-cadastro-container">
    ...
    <form class="form-cadastro-grid" method="POST" action="cadastroScript.php" enctype="multipart/form-data">
      ...
      <div class="form-section full-width">
        ...
        <p style="font-size: 20px; margin-bottom: 20px;">Selecione os estados onde esta planta é encontrada:</p>
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input class="arquivo" type="file" name="imagem[]" accept="image/*" multiple>
        </div>
      </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      mapaContainer.innerHTML = `
        <div class="mapa-section" id="mapa-conatainer"> 
          <div> 
            <div style="text-align: center; padding: 40px; background: #161616; border-radius: 8px;">
              <p style="color: #e0e0e0; font-size: 18px; margin-bottom: 15px;">
                <svg class="map-cad" xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 612 639">
                            <path
          ...
          <path
            ...
            title="Alagoas" id="2" class="estado" />
          <path
          ...
          <path
            ...
            title="Amazonas" id="4" class="estado" />
          <path
          ...
          <path
            ...
            title="Espírito Santo" id="8" class="estado" />
          <path
          ...
          <path
            ...
            title="Maranhão" id="10" class="estado" />
          <path
            ...
            title="Mato Grosso" id="11" class="estado" />
          <path
            ...
            title="Mato Grosso do Sul" id="12" class="estado" />
          <path
            ...
            title="Minas Gerais" id="13" class="estado" />
          <path
          ...
          <path
            ...
            title="Paraíba" id="15" class="estado" />
          <path
            ...
            title="Paraná" id="16" class="estado" />
          <path
            ...
            title="Pernambuco" id="17" class="estado" />
          <path
            ...
            title="Piauí" id="18" class="estado" />
          <path
            ...
            title="Rio de Janeiro" id="19" class="estado" />
          <path
            ...
            title="Rio Grande do Norte" id="20" class="estado" />
          <path
            ...
            title="Rio Grande do Sul" id="21" class="estado" />
          <path
            ...
            title="Rondônia" id="22" class="estado" />
          <path
            ...
            title="Roraima" id="23" class="estado" />
          <path
            ...
            title="Santa Catarina" id="24" class="estado" />
          <path
            ...
            title="São Paulo" id="25" class="estado" />
          <path
            ...
            title="Sergipe" id="26" class="estado" />
          <path
            ...
            title="Tocantins" id="27" class="estado" />
                </svg>
              </p>
      ...
      // Função para atualizar a seleção de um estado
      function atualizarEstado(uf, selecionar) {
        const id = ufToIdMap[uf];
        const path = document.querySelector(`#mapa-container path[id="${id}"]`);
        const btn = document.querySelector(`.estado-btn[data-uf="${uf}"]`);
        path.style.transition = "300ms";
        if (selecionar) {
          selecionados.add(uf);
          if (path) path.style.fill = "#f39c12";
          if (btn) btn.classList.add('active');
          if (btn) btn.style.backgroundColor = '#1c7924';
        } else {
          selecionados.delete(uf);
          if (path) path.style.fill = "#333";
      ...
      // Adicionar event listeners aos paths do mapa
      document.querySelectorAll("#mapa-container path").forEach(path => {
        path.style.fill = "#333";
        path.style.stroke = "#161616ff";
        ...
        path.addEventListener("click", () => {
          // Encontrar a UF correspondente ao ID do path
          let ufCorrespondente = null;
          for (const [uf, id] of Object.entries(ufToIdMap)) {
            if (id === path.id) {
              ufCorrespondente = uf;
              break;
            }
          ...
          if (ufCorrespondente) {
            const estaSelecionado = selecionados.has(ufCorrespondente);
            atualizarEstado(ufCorrespondente, !estaSelecionado);
          }
        });
      });
