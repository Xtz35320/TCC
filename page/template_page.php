    ...
    <div class="informacoes-planta">
      ...
      <div class="card">
        <div>
          ...
          <div class="bloco">
            <button class="button" id="svgcolor" onclick="mudarSlide(-1)"><svg xmlns="http://www.w3.org/2000/svg"
                width="160" height="160" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
            ...
            <button class="button" id="svgcolor" onclick="mudarSlide(1)"><svg xmlns="http://www.w3.org/2000/svg"
                width="160" height="160" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
      ...
      <div class="card" id="video">
        ...
        <iframe class="video" style="aspect-ratio: 16 / 9;" src="<?php echo htmlspecialchars($video_link) ?>"
      ...
      <div class="card">
        <svg xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/"
          ...
          <path
            ...
            title="Acre" id="Acre" class="<?php if (in_array(1, $id_estado))
                                            echo 'active';
                                          else
                                            echo 'aaa'; ?>" />
          <path
            ...
            title="Alagoas" id="Alagoas" class="<?php if (in_array(2, $id_estado))
                                                  echo 'active';
                                                else
                                                  echo 'aaa'; ?>" />
          <path
            ...
            title="Amapá" id="Amapá" class="<?php if (in_array(3, $id_estado))
                                              echo 'active';
                                            else
                                              echo 'aaa'; ?>" />
          <path
            ...
            title="Amazonas" id="Amazonas" class="<?php if (in_array(4, $id_estado))
                                                    echo 'active';
                                                  else
                                                    echo 'aaa'; ?>" />
          <path
            ...
            title="Bahia" id="Bahia" class="<?php if (in_array(5, $id_estado))
                                              echo 'active';
                                            else
                                              echo 'aaa'; ?>" />
          <path
            ...
            title="Ceará" id="Ceará" class="<?php if (in_array(6, $id_estado))
                                              echo 'active';
                                            else
                                              echo 'aaa'; ?>" />
          <path
            d="m 416.97257,334.13114 -14.69,-0.02 -0.52,-3.26 0.92,-1.83 0.38,-3.73 11.95,0.01 1.83,1.98 0.06,2.21 -0.59,1.19 -0.21,2.44 z"
            title="Distrito Federal" id="Distrito Federal" class="<?php if (in_array(7, $id_estado))
                                                                    echo 'active';
                                                                  else
                                                                    echo 'aaa'; ?>" />
          <path
            ...
            title="Espírito Santo" id="Espírito Santo" class="<?php if (in_array(8, $id_estado))
                                                                echo 'active';
                                                              else
                                                                echo 'aaa'; ?>" />
          <path
            ...
            title="Goiás" id="Goiás" class="<?php if (in_array(9, $id_estado))
                                              echo 'active';
                                            else
                                              echo 'aaa'; ?>" />
          <path
            ...
            title="Maranhão" id="Maranhão" class="<?php if (in_array(10, $id_estado))
                                                    echo 'active';
                                                  else
                                                    echo 'aaa'; ?>" />
          <path
            ...
            title="Mato Grosso" id="Mato Grosso" class="<?php if (in_array(11, $id_estado))
                                                          echo 'active';
                                                        else
                                                          echo 'aaa'; ?>" />
          <path
            ...
            title="Mato Grosso do Sul" id="Mato Grosso do Sul" class="<?php if (in_array(12, $id_estado))
                                                                        echo 'active';
                                                                      else
                                                                        echo 'aaa'; ?>" />
          <path
            ...
            title="Minas Gerais" id="Minas Gerais" class="<?php if (in_array(13, $id_estado))
                                                            echo 'active';
                                                          else
                                                            echo 'aaa'; ?>" />
          <path
            ...
            title="Pará" id="Pará" class="<?php if (in_array(14, $id_estado))
                                            echo 'active';
                                          else
                                            echo 'aaa'; ?>" />
          <path
            ...
            title="Paraíba" id="Paraíba" class="<?php if (in_array(15, $id_estado))
                                                  echo 'active';
                                                else
                                                  echo 'aaa'; ?>" />
          <path
            ...
            title="Paraná" id="Paraná" class="<?php if (in_array(16, $id_estado))
                                                echo 'active';
                                              else
                                                echo 'aaa'; ?>" />
          <path
            ...
            title="Pernambuco" id="Pernambuco" class="<?php if (in_array(17, $id_estado))
                                                        echo 'active';
                                                      else
                                                        echo 'aaa'; ?>" />
          <path
            ...
            title="Piauí" id="Piauí" class="<?php if (in_array(18, $id_estado))
                                              echo 'active';
                                            else
                                              echo 'aaa'; ?>" />
          <path
            ...
            title="Rio de Janeiro" id="Rio de Janeiro" class="<?php if (in_array(19, $id_estado))
                                                                echo 'active';
                                                              else
                                                                echo 'aaa'; ?>" />
          <path
            ...
            title="Rio Grande do Norte" id="Rio Grande do Norte" class="<?php if (in_array(20, $id_estado))
                                                                          echo 'active';
                                                                        else
                                                                          echo 'aaa'; ?>" />
          <path
            ...
            title="Rio Grande do Sul" id="Rio Grande do Sul" class="<?php if (in_array(21, $id_estado))
                                                                      echo 'active';
                                                                    else
                                                                      echo 'aaa'; ?>" />
          <path
            ...
            title="Rondônia" id="Rondônia" class="<?php if (in_array(22, $id_estado))
                                                    echo 'active';
                                                  else
                                                    echo 'aaa'; ?>" />
          <path
            ...
            title="Roraima" id="Roraima" class="<?php if (in_array(23, $id_estado))
                                                  echo 'active';
                                                else
                                                  echo 'aaa'; ?>" />
          <path
            ...
            title="Santa Catarina" id="Santa Catarina" class="<?php if (in_array(24, $id_estado))
                                                                echo 'active';
                                                              else
                                                                echo 'aaa'; ?>" />
          <path
            ...
            title="São Paulo" id="São Paulo" class="<?php if (in_array(25, $id_estado))
                                                      echo 'active';
                                                    else
                                                      echo 'aaa'; ?>" />
          <path
            ...
            title="Sergipe" id="Sergipe" class="<?php if (in_array(26, $id_estado))
                                                  echo 'active';
                                                else
                                                  echo 'aaa'; ?>" />
          <path
            ...
            title="Tocantins" id="Tocantins" class="<?php if (in_array(27, $id_estado))
                                                      echo 'active';
                                                    else
                                                      echo 'aaa'; ?>" />
        </svg>
      ...
      <div class="card">
        <div
          style="display:flex; align-items:center; gap:10px; margin-top:15px; background-color:#121212; border-radius:10px; padding:10px;">
      ...
      <div class="card">
        ...
        ?>
            <div
              style="display:flex; align-items:flex-start; gap:10px; margin-bottom:15px; background-color:#161616; border-radius:10px; padding:10px;">
        ...
        <?php if (isset($_SESSION['apoiador_id'])): ?>
          <form method="POST" action="../php/salvar_avaliacao.php"
            ...
            <textarea name="comentario" placeholder="Deixe seu comentário..."
              style="background-color:#111; color:#fff; border:none; padding:10px; border-radius:8px;"
              required></textarea>
            <button type="submit"
              style="background-color:#1c7924; color:#fff; border:none; padding:10px; border-radius:8px; cursor:pointer;">
              Enviar Avaliação
            </button>
          </form>
        <?php else: ?>
          <p style="margin-top:10px;"><a href="login.php" style="color:#1c7924;">Faça login como apoiador</a> para deixar
            sua avaliação.</p>
        <?php endif; ?>
      </div>
    </div>
        ...
        <div class="texto_pdf">
          <?php if (count($documentos) > 0): ?>
            <?php foreach ($documentos as $doc): ?>
              ...
              <button class="pdf-button" onclick="openPdfModal('<?= htmlspecialchars($doc['link_pdf']) ?>')">Abrir
                PDF</button>
            <?php endforeach; ?>
          <?php else: ?>
