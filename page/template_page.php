 <?php
  ...
  $sql = "SELECT nome_popular, nome_cientifico, descricao, cuidados, video_link, usuario_id FROM planta WHERE id = $id";
  ...
  $sql = "SELECT nome, imagem FROM usuarios WHERE id = $usuario_id";
  ...
  $sql_carac = "SELECT reino, divisao, classe, ordem, familia, genero, especie FROM caracteristicas WHERE planta_id = $id";
  $result_carac = $conn->query($sql_carac);
  ...
  if ($result_carac->num_rows > 0) {
    $row = $result_carac->fetch_assoc();
    $reino = $row['reino'];
    $divisao = $row['divisao'];
    $classe = $row['classe'];
    $ordem = $row['ordem'];
  ...
  $sql_img = "SELECT caminho_imagem, descricao FROM imagens WHERE planta_id = $id";
  ...
  $sql_mapa = "SELECT id_estado FROM planta_estado WHERE id_planta = $id";
  $result_mapa = $conn->query($sql_mapa);

  $id_estado = [];

  if ($result_mapa->num_rows > 0) {
  ...
  $sql_doc = "SELECT planta_id, tipo, titulo, link_pdf FROM documentos WHERE planta_id = $id";
  ...
  if (!isset($_SESSION['apoiador_id'])) {
    ...
    $sql_apoiador = "SELECT nome, imagem FROM usuarios WHERE id = $apoiador_id";
 ...
 <body>
   ...
   <div class="planta-e-pdf">
     <div class="informacoes-planta">
       ...
       <div class="card">
         <div>
           <h1 class="titulo"><?php echo htmlspecialchars($nome_popular) ?></h1>



           <div class="bloco">
             <button class="button" id="svgcolor" onclick="mudarSlide(-1)"><svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
               ...
               <div class="imagens" id="imagens">
                 <?php foreach ($imagens as $img): ?>
                   <img src="<?php echo htmlspecialchars($img['caminho_imagem']); ?>"
                     alt="<?php echo htmlspecialchars($img['descricao']); ?>" />
                 <?php endforeach; ?>
               </div>
             </div>
             <button class="button" id="svgcolor" onclick="mudarSlide(1)"><svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
         ...
         <div class="info_planta">
           <h2 class="subtitulo"><i><?php echo htmlspecialchars($nome_cientifico) ?></i></h2>
           <h3 class="texto">
       ...
       <div class="card">
         <div class="info_planta">
           ...
           <h3 class="texto">Reino: <?php echo htmlspecialchars($reino) ?></h3>
           <h3 class="texto">Divisão: <?php echo htmlspecialchars($divisao) ?></h3>
           <h3 class="texto">Classe: <?php echo htmlspecialchars($classe) ?></h3>
           <h3 class="texto">Ordem: <?php echo htmlspecialchars($ordem) ?></h3>
           <h3 class="texto">Família: <?php echo htmlspecialchars($familia) ?></h3>
           <h3 class="texto">Gênero: <i><?php echo htmlspecialchars($genero) ?></i></h3>
           <h3 class="texto">Espécie: <i><?php echo htmlspecialchars($especie) ?></i></h3>
         </div>
       </div>
       ...
       <div class="card">
         <svg xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/"
           ...
           <path
             ...
             title="Acre" id="Acre" class="<?php if (in_array(1, $id_estado)) echo 'active';
                                            else echo 'aaa'; ?>" />
           <path
             ...
             title="Alagoas" id="Alagoas" class="<?php if (in_array(2, $id_estado)) echo 'active';
                                                  else echo 'aaa'; ?>" />
           <path
             ...
             title="Amapá" id="Amapá" class="<?php if (in_array(3, $id_estado)) echo 'active';
                                              else echo 'aaa'; ?>" />
           <path
             ...
             title="Amazonas" id="Amazonas" class="<?php if (in_array(4, $id_estado)) echo 'active';
                                                    else echo 'aaa'; ?>" />
           <path
             ...
             title="Bahia" id="Bahia" class="<?php if (in_array(5, $id_estado)) echo 'active';
                                              else echo 'aaa'; ?>" />
           <path
             ...
             title="Ceará" id="Ceará" class="<?php if (in_array(6, $id_estado)) echo 'active';
                                              else echo 'aaa'; ?>" />
           <path
             d="m 416.97257,334.13114 -14.69,-0.02 -0.52,-3.26 0.92,-1.83 0.38,-3.73 11.95,0.01 1.83,1.98 0.06,2.21 -0.59,1.19 -0.21,2.44 z"
             title="Distrito Federal" id="Distrito Federal" class="<?php if (in_array(7, $id_estado)) echo 'active';
                                                                    else echo 'aaa'; ?>" />
           <path
             ...
             title="Espírito Santo" id="Espírito Santo" class="<?php if (in_array(8, $id_estado)) echo 'active';
                                                                else echo 'aaa'; ?>" />
           <path
             ...
             title="Goiás" id="Goiás" class="<?php if (in_array(9, $id_estado)) echo 'active';
                                              else echo 'aaa'; ?>" />
           <path
             ...
             title="Maranhão" id="Maranhão" class="<?php if (in_array(10, $id_estado)) echo 'active';
                                                    else echo 'aaa'; ?>" />
           <path
             ...
             title="Mato Grosso" id="Mato Grosso" class="<?php if (in_array(11, $id_estado)) echo 'active';
                                                          else echo 'aaa'; ?>" />
           <path
             ...
             title="Mato Grosso do Sul" id="Mato Grosso do Sul" class="<?php if (in_array(12, $id_estado)) echo 'active';
                                                                        else echo 'aaa'; ?>" />
           <path
             ...
             title="Minas Gerais" id="Minas Gerais" class="<?php if (in_array(13, $id_estado)) echo 'active';
                                                            else echo 'aaa'; ?>" />
           <path
             ...
             title="Pará" id="Pará" class="<?php if (in_array(14, $id_estado)) echo 'active';
                                            else echo 'aaa'; ?>" />
           <path
             ...
             title="Paraíba" id="Paraíba" class="<?php if (in_array(15, $id_estado)) echo 'active';
                                                  else echo 'aaa'; ?>" />
           <path
             ...
             title="Paraná" id="Paraná" class="<?php if (in_array(16, $id_estado)) echo 'active';
                                                else echo 'aaa'; ?>" />
           <path
             ...
             title="Pernambuco" id="Pernambuco" class="<?php if (in_array(17, $id_estado)) echo 'active';
                                                        else echo 'aaa'; ?>" />
           <path
             ...
             title="Piauí" id="Piauí" class="<?php if (in_array(18, $id_estado)) echo 'active';
                                              else echo 'aaa'; ?>" />
           <path
             ...
             title="Rio de Janeiro" id="Rio de Janeiro" class="<?php if (in_array(19, $id_estado)) echo 'active';
                                                                else echo 'aaa'; ?>" />
           <path
             ...
             title="Rio Grande do Norte" id="Rio Grande do Norte" class="<?php if (in_array(20, $id_estado)) echo 'active';
                                                                          else echo 'aaa'; ?>" />
           <path
             ...
             title="Rio Grande do Sul" id="Rio Grande do Sul" class="<?php if (in_array(21, $id_estado)) echo 'active';
                                                                      else echo 'aaa'; ?>" />
           <path
             ...
             title="Rondônia" id="Rondônia" class="<?php if (in_array(22, $id_estado)) echo 'active';
                                                    else echo 'aaa'; ?>" />
           <path
             ...
             title="Roraima" id="Roraima" class="<?php if (in_array(23, $id_estado)) echo 'active';
                                                  else echo 'aaa'; ?>" />
           <path
             ...
             title="Santa Catarina" id="Santa Catarina" class="<?php if (in_array(24, $id_estado)) echo 'active';
                                                                else echo 'aaa'; ?>" />
           <path
             ...
             title="São Paulo" id="São Paulo" class="<?php if (in_array(25, $id_estado)) echo 'active';
                                                      else echo 'aaa'; ?>" />
           <path
             ...
             title="Sergipe" id="Sergipe" class="<?php if (in_array(26, $id_estado)) echo 'active';
                                                  else echo 'aaa'; ?>" />
           <path
             ...
             title="Tocantins" id="Tocantins" class="<?php if (in_array(27, $id_estado)) echo 'active';
                                                      else echo 'aaa'; ?>" />
         </svg>
       </div>
       ...
       <div class="card">
         <h1 class="titulo">Como cuidar da <?php echo htmlspecialchars($nome_popular) ?></h1>
         <h3 class="texto"><?php echo htmlspecialchars($cuidados) ?> </h3>
        </h3>
      </div>

      <div class="card">
        <div style="display:flex; align-items:center; gap:10px; margin-top:15px; background-color:#161616; border-radius:10px; padding:10px;">
      
          <span style=" font-weight:bold;">
            Cadastrado por: <?php echo htmlspecialchars($nome_usuario ?? ""); ?>
          </span>
      
          <img src="<?php echo htmlspecialchars($imagem_usuario ?? ""); ?>"
       ...
       <div class="card">
         ...
         <?php
          $sql_avaliacoes = "
            ...
            FROM avaliacao a
            JOIN usuarios ap ON ap.id = a.usuario_id
         ...
         <?php else: ?>
           <p style="margin-top:10px;"><a href="login.php" style="color:#1c7924;">Faça login como apoiador</a> para deixar sua avaliação.</p>
         <?php endif; ?>
       </div>
     </div>
         ...
         <div class="texto_pdf">
           <?php if (count($documentos) > 0): ?>
             <?php foreach ($documentos as $doc): ?>
               <h2 class="titulo-pdf"><?= htmlspecialchars($doc['titulo']) ?></h2>
               <h3 class="texto"><?= htmlspecialchars($doc['tipo']) ?></h3>
               <button class="pdf-button" onclick="openPdfModal('<?= htmlspecialchars($doc['link_pdf']) ?>')">Abrir PDF</button>
             <?php endforeach; ?>
           <?php else: ?>
