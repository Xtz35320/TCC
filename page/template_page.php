...
// Consulta dos dados da planta
$sql = "SELECT nome_popular, nome_cientifico, descricao, cuidados, video_link FROM planta WHERE id = $id";
...
if ($result_doc->num_rows > 0) {
  while ($row = $result_doc->fetch_assoc()) {
    $documentos[] = $row; // adiciona cada documento ao array
  }
}
