...
<head>
  ...
  <title>Login do usuarios | Botan Mind</title>
  ...
  <main style="margin-top:80px; min-height:60vh;">
    <div class="form-apoiador" style="max-width:400px; margin:60px auto;">
      ...
      <p style="text-align:center; margin-top:10px;">
        Ainda não tem uma conta? <a href="cadastrousuarios.php" style="color:#1c7924;">Cadastre-se aqui</a>
      </p>
    </div>
  </main>
